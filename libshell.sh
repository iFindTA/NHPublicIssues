...
#rm $divide
cd .. && ar rcs armv7.a armv7/ACKApi.o
...
#rm $divide
cd .. && ar rcs arm64.a arm64/ACKApi.o
...
#rm $divide
cd .. && ar rcs i386.a i386/ACKApi.o
...
#rm $divide
cd .. && ar rcs x86.a x86/ACKApi.o

#union the sdks
lipo -create arm64.a armv7.a i386.a x86.a -output libACKSDK.a
